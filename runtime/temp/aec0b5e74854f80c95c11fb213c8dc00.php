<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"/Applications/XAMPP/xamppfiles/htdocs/medias/public/../application/admin/view/index/top.html";i:1489136210;}*/ ?>
...
<title>top</title>
<link href="javascript/skin/css/base.css" rel="stylesheet" type="text/css">
...
{
  text-align:center;
	background:url(javascript/skin/images/frame/topitembg.gif) 0px 3px no-repeat;
	width:82px;
	height:26px;
	line-height:28px;
}
...
<body bgColor='#ffffff'>
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="javascript/skin/images/frame/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="javascript/skin/images/frame/logo.jpg"/></td>
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="60" style="padding-right:10px;line-height:26px;">
        	...
        	[<a href="<?php echo url('user/UserAdd',['user_id'=>$UserId,'edit'=>3]); ?>" target="main">修改密码</a>]
    ...
    <!-- <tr>
		...
		<dl id="tpa">
		<dd class='img'><a href="javascript:ChangeMenu(-1);"><img vspace="5" src="javascript/skin/images/frame/arrl.gif" border="0" width="5" height="8" alt="缩小左框架"  title="缩小左框架" /></a></dd>
		<dd class='img'><a href="javascript:ChangeMenu(0);"><img vspace="3" src="javascript/skin/images/frame/arrfc.gif" border="0" width="12" height="12" alt="显示/隐藏左框架" title="显示/隐藏左框架" /></a></dd>
