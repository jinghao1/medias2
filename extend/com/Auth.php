...
class Auth{
    ...
    protected $_config = array(
        ...
        'auth_group'        => 'zt_auth_group',        // 用户组数据表名
        'auth_group_access' => 'zt_auth_user_group', // 用户-用户组关系表
        'auth_rule'         => 'zt_auth_rule',         // 权限规则表
        'auth_user'         => 'zt_admin'             // 用户信息表
    );
    ...
    protected function getUserInfo($uid) {
        ...
        if(!isset($userinfo[$uid])){
             $userinfo[$uid]=\think\Db::table('zt_admin')->where('user_id',$uid)->find();
        }
        return $userinfo[$uid];
    }
